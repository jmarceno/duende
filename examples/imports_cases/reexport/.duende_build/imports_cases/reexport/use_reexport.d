module imports_cases.reexport.use_reexport;

import mod2 = imports_cases.reexport.mod2;
alias mod1 = mod2.mod1;
...
int main() {
    (() { static if (is(typeof(writeln(mod1.add(1, 2))) == void)) { writeln(mod1.add(1, 2)); } else { auto __du_tmp = writeln(mod1.add(1, 2)); duende_eval(__du_tmp); } })();
    return 0;
}
