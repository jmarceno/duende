module imports_cases.circular.use_circular;

import a = imports_cases.circular.a;
import b = imports_cases.circular.b;
...
int main() {
    (() { static if (is(typeof(writeln(a.fa())) == void)) { writeln(a.fa()); } else { auto __du_tmp = writeln(a.fa()); duende_eval(__du_tmp); } })();
    (() { static if (is(typeof(writeln(b.fb())) == void)) { writeln(b.fb()); } else { auto __du_tmp = writeln(b.fb()); duende_eval(__du_tmp); } })();
    return 0;
}
