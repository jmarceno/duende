module imports_cases.multi_alias.use_aliases;

import lib = imports_cases.multi_alias.lib;
alias aa = lib.a;
alias bb = lib.b;
alias c = lib.c;
...
int main() {
    (() { static if (is(typeof(writeln(aa())) == void)) { writeln(aa()); } else { auto __du_tmp = writeln(aa()); duende_eval(__du_tmp); } })();
    (() { static if (is(typeof(writeln(bb())) == void)) { writeln(bb()); } else { auto __du_tmp = writeln(bb()); duende_eval(__du_tmp); } })();
    (() { static if (is(typeof(writeln(c())) == void)) { writeln(c()); } else { auto __du_tmp = writeln(c()); duende_eval(__du_tmp); } })();
    return 0;
}
